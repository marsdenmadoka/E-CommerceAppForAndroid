...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (overTotalPrice ==0 ) {
                    Toast.makeText(CartActivity.this, "please place an order", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        super.onStart();
//fetchin from db to dislpay in cartActivity
        final DatabaseReference cartListRef = FirebaseDatabase.getInstance().getReference().child("Cart List");

        FirebaseRecyclerOptions<Cart> options = //cart is our model class
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("User View")
                                .child(Prevalent.currentOnlineUser.getPhone())
                                .child("CartProducts"), Cart.class)
                        .build();
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                ...
                                if (i == 1)
                                {
                                    cartListRef.child("User View")
                                            .child(Prevalent.currentOnlineUser.getPhone())
                                            .child("CartProducts")
                                            .child(model.getPid()) //the unique ID which the user want to remove
                                            .removeValue()
